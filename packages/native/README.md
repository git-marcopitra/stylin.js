# STYLIN.JS for React Native

![Stylin Logo](../../public/logo.png)

A **React Native** styling library with features like in-component styles, Theme-Based properties, suggestive, primitive CSS allowed.
...
```sh
# npm
npm install @stylin.js/native

# yarn
yarn add @stylin.js/native
```
