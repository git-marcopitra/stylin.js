...
Now, to use `@stylin.js/react`, you must to create the stylin element by your own, and with `@stylin.js/elements`, you can access all the _stylable_ html elements as **StylinComponents**.
